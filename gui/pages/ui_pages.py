...
################################################################################
## Form generated from reading UI file 'pagesRpakVE.ui'
##
...
class Ui_application_pages(object):
    def setupUi(self, application_pages):
        ...
        application_pages.resize(940, 537)
        self.page_1 = QWidget()
    ...
    def retranslateUi(self, application_pages):
        ...
        self.label.setText(QCoreApplication.translate("application_pages", u"Pagina Inicial", None))
